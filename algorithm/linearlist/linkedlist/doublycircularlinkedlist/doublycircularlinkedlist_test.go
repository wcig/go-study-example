...
func printList(list *DoubleCircularLinkedList) {
...
func TestCircular1(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		fmt.Println(list.ValuesStartIndex(i), list.ValuesReverseStartIndex(i))
	}
	// Output:
...
func TestCircular2(t *testing.T) {
	...
	// [3 4 0 1 2] [3 2 1 0 4]
	// [4 0 1 2 3] [4 3 2 1 0]
	// list size: 5, empty: false, value: [4 3 2 1 0]
	// [4 3 2 1 0] [4 0 1 2 3]
	// [3 2 1 0 4] [3 4 0 1 2]
	// [2 1 0 4 3] [2 3 4 0 1]
	// [1 0 4 3 2] [1 2 3 4 0]
	// [0 4 3 2 1] [0 1 2 3 4]
	// list size: 6, empty: false, value: [4 3 200 2 1 0]
	// [4 3 200 2 1 0] [4 0 1 2 200 3]
	// [3 200 2 1 0 4] [3 4 0 1 2 200]
	// [200 2 1 0 4 3] [200 3 4 0 1 2]
	// [2 1 0 4 3 200] [2 200 3 4 0 1]
	// [1 0 4 3 200 2] [1 2 200 3 4 0]
}
...
func TestCircular3(t *testing.T) {
	...
	// [3 1] [3 1]
	// [] []
	// list size: 1, empty: false, value: [1]
	// [1] [1]
	// [] []
